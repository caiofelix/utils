...
run mkdir /var/lib/yii
run	wget --no-check-certificate https://github.com/yiisoft/yii/releases/download/1.1.16/yii-1.1.16.bca042.tar.gz -O yii.tar.gz
run tar -xvf yii.tar.gz -C /var/lib/yii --strip 1
run rm yii.tar.gz
env     YIIFRAMEWORK=/var/lib/yii
